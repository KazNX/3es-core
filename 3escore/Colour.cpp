...
const ColourSet &ColourSet::predefined(PredefinedSet name)
{
  static const std::array<ColourSet, LastSet + 1> sets = {
    ...
    ColourSet{
      ...
      Colour(Colour::LightSlateGrey),
      Colour(Colour::SlateGrey),
      Colour(Colour::DarkSlateGrey),
      Colour(Colour::Black),
      Colour(Colour::White),
      Colour(Colour::Snow),
      Colour(Colour::Honeydew),
      Colour(Colour::MintCream),
      Colour(Colour::Azure),
      Colour(Colour::AliceBlue),
      Colour(Colour::GhostWhite),
      Colour(Colour::WhiteSmoke),
      Colour(Colour::Seashell),
      Colour(Colour::Beige),
      Colour(Colour::OldLace),
      Colour(Colour::FloralWhite),
      Colour(Colour::Ivory),
      Colour(Colour::AntiqueWhite),
      Colour(Colour::Linen),
      Colour(Colour::LavenderBlush),
      Colour(Colour::MistyRose),
      Colour(Colour::Pink),
      Colour(Colour::LightPink),
      ...
      Colour(Colour::LemonChiffon),
      Colour(Colour::LightGoldenrodYellow),
      Colour(Colour::PapayaWhip),
      Colour(Colour::Moccasin),
      Colour(Colour::PeachPuff),
      Colour(Colour::PaleGoldenrod),
      Colour(Colour::Khaki),
      Colour(Colour::DarkKhaki),
      Colour(Colour::Gold),
      Colour(Colour::Cornsilk),
      Colour(Colour::BlanchedAlmond),
      Colour(Colour::Bisque),
      Colour(Colour::NavajoWhite),
      Colour(Colour::Wheat),
      Colour(Colour::BurlyWood),
      Colour(Colour::Tan),
      Colour(Colour::RosyBrown),
      Colour(Colour::SandyBrown),
      Colour(Colour::Goldenrod),
