...
if(NOT TES_CORE_BUILD_SHARED AND NOT BUILD_SHARED_LIBS)
  # zlib is only a dependency when using static libraries.
  set(CPACK_DEBIAN_CORE_PACKAGE_DEPENDS zlib1g)
endif(NOT TES_CORE_BUILD_SHARED AND NOT BUILD_SHARED_LIBS)
set(CPACK_DEBIAN_UTIL_PACKAGE_DEPENDS ${CPACK_DEBIAN_CORE_PACKAGE_DEPENDS})
...
set(CPACK_DEBIAN_VIEWER_PACKAGE_DEPENDS zenity)
